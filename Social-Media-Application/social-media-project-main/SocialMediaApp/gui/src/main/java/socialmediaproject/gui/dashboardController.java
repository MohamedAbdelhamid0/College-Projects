...
public class dashboardController implements Initializable{
    ...
    @FXML
    private void btnCreatePost(ActionEvent event)throws IOException{
        AnchorPane view = FXMLLoader.load(getClass().getResource("createPost.fxml"));
        borderplane.setCenter(view);
    }

    @FXML
    private void btnViewFeed(ActionEvent event)throws IOException{
        AnchorPane view = FXMLLoader.load(getClass().getResource("viewFeed.fxml"));
        borderplane.setCenter(view);
    }

    @FXML
    private void btnFriends(ActionEvent event)throws IOException{
