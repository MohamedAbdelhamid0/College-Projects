...
----------------------
    ...
    --prompt-mode         fixed | seeded | random
    --prompt-seed         Seed used for seeded prompt selection
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--prompt-mode",
        default=os.environ.get("PROMPT_MODE", "fixed"),
        choices=["fixed", "seeded", "random"],
        dest="prompt_mode",
        help="Prompt selection mode (default: fixed)",
    )
    parser.add_argument(
        "--prompt-seed",
        type=int,
        default=int(os.environ.get("PROMPT_SEED", 42)),
        dest="prompt_seed",
        help="Seed used when prompt-mode=seeded (default: 42)",
    )
    parser.add_argument(
